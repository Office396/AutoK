"""
GUI Message Formats View
Allows users to customize WhatsApp message formats for each alarm type
"""
...
class MessageFormatsView(ctk.CTkFrame):
    """Message format customization view"""
    ...
    def _reset_defaults(self):
        ...
        from config import MessageFormatSettings
        defaults = MessageFormatSettings()
        
        self.mbu_entry.delete(0, "end")
        self.mbu_entry.insert(0, defaults.mbu_format)
        
        self.toggle_entry.delete(0, "end")
        self.toggle_entry.insert(0, defaults.toggle_format)
        
        self.b2s_entry.delete(0, "end")
        self.b2s_entry.insert(0, defaults.b2s_format)
        
        self.omo_entry.delete(0, "end")
        self.omo_entry.insert(0, defaults.omo_format)
